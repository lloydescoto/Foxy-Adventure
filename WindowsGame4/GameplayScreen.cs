...
namespace WindowsGame4
{
    class GameplayScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            mainbackground.Initialize(content, "desert_BG", ScreenManager.GraphicsDevice.Viewport.Width, -1);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.DrawString(smallFont, "Level 1", new Vector2(ScreenManager.GraphicsDevice.Viewport.TitleSafeArea.X + 380, ScreenManager.GraphicsDevice.Viewport.TitleSafeArea.Y), Color.White);
            spriteBatch.DrawString(smallFont, "Goal : 3000", new Vector2(ScreenManager.GraphicsDevice.Viewport.TitleSafeArea.X + 720, ScreenManager.GraphicsDevice.Viewport.TitleSafeArea.Y), Color.White);
            ...
            for (int x = 0; x < projectiles.Count; x++)
            {
                ...
                for (int y = 0; y < enemiesRockStone.Count; y++)
                {
                    ...
                    if(projectile.Intersects(enemyRockStoneSpace))
                    {
                        ...
                        if(score >= 3000)
                        {
                            LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new GameplayLevel2Screen());
                        }
                    }
                }            
