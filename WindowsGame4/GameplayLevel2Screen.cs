...
{
    class GameplayLevel2Screen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            mainbackground.Initialize(content, "yellow", ScreenManager.GraphicsDevice.Viewport.Width, -1);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin();
            spriteBatch.DrawString(smallFont, "Level 2", new Vector2(ScreenManager.GraphicsDevice.Viewport.TitleSafeArea.X + 380, ScreenManager.GraphicsDevice.Viewport.TitleSafeArea.Y), Color.White);
            spriteBatch.DrawString(smallFont, "Goal : 5000", new Vector2(ScreenManager.GraphicsDevice.Viewport.TitleSafeArea.X + 720, ScreenManager.GraphicsDevice.Viewport.TitleSafeArea.Y), Color.White);
            ...
            for (int x = 0; x < projectiles.Count; x++)
            {
                ...
                for (int y = 0; y < enemiesSkullStone.Count; y++)
                {
                    ...
                    if (projectile.Intersects(enemySkullStoneSpace))
                    {
                        ...
                        if (score >= 5000)
                        {
                            LoadingScreen.Load(ScreenManager, true, ControllingPlayer, new GameplayLevel3Screen());
                        }
                    }
                }
